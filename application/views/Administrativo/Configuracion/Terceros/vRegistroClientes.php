<style type="text/css">
	...
	input[type=number][data-db=ListaPrecio]::-webkit-outer-spin-button,
	input[type=number][data-db=ListaPrecio]::-webkit-inner-spin-button {
		-webkit-appearance: inner-spin-button !important;
		opacity: 1 !important;
	}
	input[type=number][data-db=ListaPrecio] {
		...
		<div class="col-xl-12">
			<div class="row form-group">
				<div class="custom-control custom-checkbox col-6 col-md-12 col-xl-6">
					<input type="checkbox" class="custom-control-input noBloquear" id="Cliente" checked data-db="EsCliente" readonly disabled data-nombre="Es Cliente" data-permiso="86">
					<label class="custom-control-label" for="Cliente">Es Cliente</label>
				</div>
				<div class="custom-control custom-checkbox col-6 col-md-12 col-xl-6">
					<input type="checkbox" class="custom-control-input noBloquear" id="Proveedor" data-db="EsProveedor" readonly disabled data-nombre="Es Proveedor" data-permiso="86">
		...
		<div class="text-center">
			...
			<div class="col">
				<div class="row">
					...
					<a href="<?= base_url() ?>Administrativo/Configuracion/Terceros/RegistroClientes/Exportar" target="_blank" class="col-xl-3 btn btn-outline-secondary col-3 col-md-6 col-xl-3 p-0 rounded-0">
	...
	<form id="frmRegistroClientes" class="col-md-9">
		...
		<div class="card border-top-0" style="border-top-left-radius: 0;border-top-right-radius: 0;">
			<div class="card-body tab-content">
				<div class="tab-pane fade show active" id="informacionBasica" role="tabpanel">
					<div class="card card-body d-table w-100 form-group pt-0 pb-1">
						<div class="row">
							...
							<div class="col-md-8 col-xl-1 p-0">
								<select class="form-control form-control-sm chosRes chosen-select" data-db="estado" data-nombre="Estado" data-permiso="92">
					...
					<div class="card card-body d-table w-100 form-group pt-0 pb-1">
						<div class="row">
							...
							<div class="col-md-8 col-xl-4 p-0">
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm w-25" data-db="TipoTercId" data-tabla="Cliente" maxlength="15" data-nombre="Tipo Tercero" data-foranea="TipoTerc" data-foranea-codigo="tipotercid" data-permiso="80">
									<div class="input-group-append w-75">
				...
				<div class="tab-pane fade" id="otraInformacionCRM">
					<div class="card card-body d-table w-100 form-group pt-0 pb-1">
						...
						<div class="row">
							...
							<div class="col-md-8 col-xl-6 p-0">
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm" data-db="ActividadId" data-tabla="Cliente" maxlength="15" data-nombre="Actividad Económica" data-foranea="Actividad" data-foranea-codigo="actividadid" data-permiso="49">
									<div class="input-group-append w-75">
						...
						<div class="row">
							...
							<div class="col-md-8 col-xl-6 p-0">
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm" data-db="VendedorId" data-tabla="Cliente" maxlength="15" data-nombre="Vendedor" data-foranea="Vendedor" data-foranea-codigo="VendedorId" data-permiso="39">
									<div class="input-group-append w-75">
						...
						<div class="row">
							...
							<label class="col-md-4 col-xl-3 col-form-label col-form-label-md text-md-right pl-0 py-0">Responsabilidades Fiscales</label>
							<div class="col-md-8 col-xl-4 p-0">
					...
					<div class="card card-body d-table w-100 form-group pt-0 py-1">
						<div class="row">
							...
							<div class="col-md-7 col-xl-3 p-0">
								<div class="input-group input-group-sm">
									<input type="text" class="form-control form-control-sm numeric4 w-75" data-db="TariReteIdNombre" maxlength="12" data-foranea="TariRete" data-foranea-codigo="tarifa" data-permiso="52">
									<div class="input-group-append w-25">
										<input type="text" class="form-control form-control-sm input-group-addon" data-db="TariReteId" data-tabla="Cliente" readonly data-nombre="Tarifa Retención en la Fuente" data-foranea="TariRete" data-foranea-codigo="tarireteid" data-permiso="52" style="border-bottom-left-radius: 0;border-top-left-radius: 0;">
									</div>
								</div>
							</div>
							...
							<div class="col-md-7 col-xl-1 p-0">
								<select class="form-control form-control-sm" data-db="SobreBase" data-nombre="Liquida Retención en la FUente Sobre Base" data-tabla="Cliente" data-permiso="53">
									<option value="" disabled selected hidden></option>
						...
						<div class="row">
							...
							<div class="col-md-7 col-xl-2 p-0">
								<input type="text" class="form-control form-control-sm numeric4" data-db="TarifRetIv" data-tabla="Cliente" maxlength="12" data-nombre="Tarifa Retención IVA" data-permiso="51">
							</div>
						</div>
						<div class="row form-group">
						...
						<div class="row">
							...
							<div class="col-md-7 col-xl-1 p-0">
								<input type="text" class="form-control form-control-sm numeric" data-db="Dias" maxlength="3" data-nombre="Días Crédito Compras" data-tabla="Cliente" data-permiso="47">
							</div>
				...
				<div class="tab-pane fade" id="sucursales" data-crud-tabla="Sucursal" data-crud-dt="dtSucursales">
					<div class="card card-body d-table w-100 form-group pt-0 pb-1">
						<div class="row">
							<b class="w-100">Datos residenciales</b>

							<label class="col-md-4 col-xl-3 col-form-label col-form-label-md text-md-right pl-0 py-0"><span class="text-danger">*</span>Tipo de vivienda</label>
							<div class="col-md-6 col-xl-3 p-0">
								<select class="form-control form-control-sm chosRes chosen-select" id="chTipoVivienda">
							...
							<label class="col-md-4 col-xl-3 col-form-label col-form-label-md text-md-right pl-0 py-0"><span class="text-danger">*</span>Vivienda</label>
							<div class="col-md-6 col-xl-3 p-0">
								<select class="form-control form-control-sm chosRes chosen-select" id="chVivienda">
									<option value="" selected disabled>Seleccione</option>
								</select>
							</div>
							<label class="col-md-4 col-xl-2 col-form-label col-form-label-md text-md-right pl-0 py-0">Propietario</label>
							<div class="col-md-2 col-xl-1 p-0">
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="cProp">
								</div>
							</div>
							<label class="col-md-4 col-xl-2 col-form-label col-form-label-md text-md-right pl-0 py-0">Residente</label>
							<div class="col-md-2 col-xl-1 p-0">
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="cRes">
								</div>
							</div>
							<label class="col-md-4 col-xl-1 col-form-label col-form-label-md text-md-right pl-0 py-0">Titular</label>
							<div class="col-md-2 col-xl-1 p-0">
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="cTitular">
								</div>
							</div>
							<label class="col-md-4 col-xl-2 col-form-label col-form-label-md text-md-right pl-0 py-0">Incl. en directorio</label>
							<div class="col-md-2 col-xl-1 p-0">
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="cDir">
								</div>
							</div>
							<div class="col-12 p-0 mt-3">
								<button type="button" class="btn btn-primary btn-sm col-md-3 col-xl-2 float-right" id="btnAgregaRes" title="Agregar Ítem"><i class="fas fa-plus"></i> Agregar</button>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xl-11">
								<div class="row">
									...
									<label class="col-md-4 col-xl-2 col-form-label col-form-label-md text-md-right pl-0 py-0">Nombre</label>
									<div class="col-md-8 col-xl-10 p-0">
										<input type="text" class="form-control form-control-sm" data-crud="nombre" maxlength="100" data-nombre="Razón Social Sucursal">
									</div>
									<label class="col-md-4 col-xl-2 col-form-label col-form-label-md text-md-right pl-0 py-0">Dirección</label>
									<div class="col-md-8 col-xl-10 p-0">
					...
					<table id="tblResidencia" class="table table-bordered table-condensed nowrap table-hover" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>Acciones</th>
								<th>Id</th>
						...
						<div class="row">
							<div class="col-xl-11">
								...
								<div class="row">
									...
									<div class="col-md-8 col-xl-3 p-0">
										<div class="input-group datepicker input-group-sm">
											<input type="text" class="form-control form-control-sm datepicker" value="<?= date('Y-m-d') ?>" data-crud="fechanacim" maxlength="10" data-nombre="Fecha de Nacimiento Contacto" data-permiso="75">
											<a href="#" class="input-group-append input-group-addon" title="Desplegar Calendario">
												<span class="input-group-text fas fa-calendar-alt d-flex"></span>
											</a>
										</div>
