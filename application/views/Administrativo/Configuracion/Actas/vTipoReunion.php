<div data-auto class="d-none">
	<label class="mb-0" for="TipoReunionId"><span class="text-danger">*</span>Código</label>
	<input type="text" class="form-control form-control-sm data-int" data-db="TipoReunionId" data-required data-codigo data-identity-insert>
</div>
