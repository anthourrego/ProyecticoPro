<label class="mb-0" for="centroproduccionid"><span class="text-danger">*</span>Código</label>
<input type="text" class="form-control form-control-sm" data-db="centroproduccionid" maxlength="15" data-required data-codigo>
