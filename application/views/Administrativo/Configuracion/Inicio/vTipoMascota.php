<div data-auto class="d-none">
	...
	<input type="text" class="form-control form-control-sm data-int" data-db="TipoMascotaId" data-required data-codigo data-identity-insert>
</div>
...
<label class="mb-0" for="TipoViviendaId"><span class="text-danger">*</span>Estado</label>
