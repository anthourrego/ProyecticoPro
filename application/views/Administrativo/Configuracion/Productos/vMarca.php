<label class="mb-0" for="marcaid"><span class="text-danger">*</span>Código</label>
<input type="text" class="form-control form-control-sm" data-db="marcaid" maxlength="15" data-required data-codigo>
