<div data-auto class="d-none">
	<label class="mb-0" for="UnidadMedidaId"><span class="text-danger">*</span>UnidadMedidaId</label>
	<input type="text" class="form-control form-control-sm data-int" data-db="UnidadMedidaId" data-required data-codigo data-identity-insert>
</div>
