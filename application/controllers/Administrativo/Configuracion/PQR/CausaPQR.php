...
class CausaPQR extends MY_CRUD_Controller {

	function __construct() {
		parent::__construct();

		if (!$this->session->userdata("login") ||  !in_array(1303, $this->session->userdata('SEGUR'))){
			redirect(base_url());
		} 
	...
	function index() {
		...
		$contenido['titulo'] = 'Causa PQR';
		$contenido['tblNombre'] = 'CausaPQR';
		$contenido['content_page'] = 'Administrativo/Configuracion/PQR/vCausaPQR';
